				...
				<Link
					className={clsx(
						` rounded-md ${active && "bg-slate-600 dark:bg-slate-900"} ${
							active && "text-white"
						} hover:bg-text-white flex w-full animate-fadeDown flex-col items-center  gap-1 px-3 py-1 text-center text-gray-500 transition-all duration-300 ease-in-out hover:bg-slate-600 hover:text-white dark:text-white dark:hover:bg-slate-900`,
					)}
					href={{ pathname: href }}
				>
					{icon}
